                            ...
                            <div class="content">
                                <form action="" method="post">
                                    <div class="row">
                                        ...
                                        <div class="col-md-2">
                                            <div class="form-group">
                                                <button class="form-control btn btn-success btn-fill">Envoyer</button>
                                            </div>
                                        </div>
                                    </div>
                                </form>
    ...
    <script>
        $(document).ready(function(){
            ...
            function refresh_table(){
                $("#theTable").html("");
                $.get("ajax/notificationAjax.php",{refresh: true},function(data){
            ...
            function refresh_table1(){
                $("#theTable1").html("");
                $.get("ajax/notificationAjax.php",{refresh1: true},function(data){

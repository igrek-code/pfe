    ...
    if($_SERVER["REQUEST_METHOD"] == "POST"){
        ...
        if(isset($typeProduction) && $typeProduction != "") 
            switch ($typeProduction) {
                case 'publication':
                    $error = modifier_publication($db,$codepro,$needsValidation,$postedBy);
                break;
                
                case 'communication':
                    $error = modifier_communication($db,$codepro,$needsValidation,$postedBy);
                break;
                case 'ouvrage':
                    $error = modifier_ouvrage($db,$codepro,$needsValidation,$postedBy);
                break;

                case 'chapitreOuvrage':
                    $error = modifier_chapitreOuvrage($db,$codepro,$needsValidation,$postedBy);
                break;

                case 'doctorat':
                    $error = modifier_doctorat($db,$codepro,$needsValidation,$postedBy);
                break;

                default:
                    $error = modifier_master($db,$codepro,$needsValidation,$postedBy);
                break;
            }

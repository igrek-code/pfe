<?php
    ...
    if(isset($_GET["typeProduction"]) && $_GET["typeProduction"] != ""){
        ...
        switch ($_GET["typeProduction"]) {
            ...
            case 'communication':
                afficher_communication($db,$idcher);
            break;

            case 'ouvrage':
                afficher_ouvrage($db,$idcher);
            break;

            case 'chapitreOuvrage':
                afficher_chapitreOuvrage($db,$idcher);
            break;

            case 'doctorat':
                afficher_doctorat($db,$idcher);
            break;

            case 'master':
                afficher_master($db,$idcher);
            break;
    ...
    function afficher_master($db,$idcher){
        $sql = "SELECT * FROM pfemaster WHERE encadreur ='".$idcher."'";
    ...
    function afficher_chapitreOuvrage($db,$idcher){
    ...
    function afficher_ouvrage($db,$idcher){
    ...
    function afficher_communication($db,$idcher){
            ...
            switch ($typeProduction) {
                ...
                case 'master':
                    ...
                    if(mysqli_num_rows($result) > 0){
                        ...
                        echo '<span class="text-info">Titre: </span>'.$titre.'<br>';
                        echo '<span class="text-info">№ projet: </span>'.$nprojet.'<br>';
                        echo '<span class="text-info">Date de soutenance: </span>'.$date.'<br>';
                        echo '<span class="text-info">Lieu: </span>'.$lieusout.'<br>';
                        echo '<span class="text-info">Domaine: </span>'.$nomDomaine.'<br>';
                        echo '<span class="text-info">Spécialités: </span>'.$nomspe.'<br>';

                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="card" style="padding-bottom:20px;">
                            ...
                            <div class="header">
                                <!--<h5 style="margin-bottom:15px;" class="title">Seléctionner un domaine</h5>-->
                                <div class="row">
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            <label >Selectionner un domaine</label>
                                            <select class="selectpicker form-control" name="codeDomaine" id="codeDomaine" >
                            ...
                            <div class="header">
                                <h4 class="title">Liste des laboratoires
                                    <span id="typeListe"></span>
                                    <a  class="btn btn-success btn-lg btn-fill pull-right" href="ajouterLabo.php" title="ajouter">+</a>
                                </h4>
    ...
    <script>
        $(document).ready(function(){
            ...
            function refresh_table(){
                var codeDomaine = $("#codeDomaine").val();
                var nomDomaine = $('#codeDomaine option[value="'+codeDomaine+'"]').html();
                if(codeDomaine == "all") 
                    $("#typeListe").html(" (Tous les domaines)");
                else 
                    ...
                    $.confirm({
                        ...
                        buttons : {
                            supprimer : {
                                ...
                                action : function (){
                                    $.get("ajax/adminGererLaboAjax.php",{supprimerLabo : val},function (data) {
                                        if(data == "?>true"){
                                            $.notify({
